...
@section('title') پیوند شماره {{ $slider->id }} @endsection
@section('content')
    ...
    <div class="card">
      <div class="card-header border-0 justify-content-between ">
        ...
        <div class="d-flex">
          ...
          <button onclick="confirmDelete('delete-{{ $slider->id }}')" class="btn btn-danger ml-2">
        ...
        <div class="card-body">
          <div class="row d-flex justify-content-between">
            ...
            <div class="col-12 d-flex align-items-center">
              ...
              <span class="fs-18 mr-2">{{ $slider->link }}</span>
            </div>
            <div class="col-12 d-flex align-items-center ">
