<div class="card">
  <div class="card-header border-0">
    ...
    <a href="{{route("admin.announcement.index")}}" class="action-btns1 mr-5">
      <i class="feather feather-refresh-cw text-warning"></i>
    </a>
  </div>
  <div class="card-body">
    <div class="row">
      <form action="{{ route("admin.announcement.index") }}" class="col-12">
        <div class="row">
          <div class="col-3">
            <div class="form-group">
              <label class="form-label font-weight-bold">نام منتشر کننده :</label>
          ...
          <div class="col-3">
            <div class="form-group">
              <label class="form-label font-weight-bold">تیتر :</label>
              <input type="text" name="title" value="{{ request("title") }}" class="form-control"/>
            </div>
          </div>
          <div class="col-2">
            <div class="form-group">
              <label for="from_date_show" class="form-label font-weight-bold">از تاریخ :</label>
          ...
          <div class="col-2">
            <div class="form-group">
              <label for="to_date_show" class="form-label font-weight-bold">تا تاریخ :</label>
