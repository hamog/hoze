<div class="card">
  <div class="card-header border-0">
    ...
    <a href="{{route("admin.news.index")}}" class="action-btns1 mr-5">
      <i class="feather feather-refresh-cw text-warning"></i>
    </a>
  </div>
  <div class="card-body">
    <div class="row">
      <form action="{{ route("admin.news.index") }}" class="col-12">
        <div class="row">
          ...
          <div class="col-4 form-group">
            <label style="font-weight: bold;">ویژه :</label>
            <select name="featured" class="form-control">
              <option value="all">همه</option>
              <option value="1"  @selected(request("featured") == "1")>باشد</option>
              <option value="0"  @selected(request("featured") == "0")>نباشد</option>
            </select>
          </div>
